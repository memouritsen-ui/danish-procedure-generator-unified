...
| P5-003 | Create GET /api/runs/{id}/gates | [x] 10 tests (1651 total) | `pytest tests/api/test_gates_endpoint.py` | Return gate status |
...
| P5: API & Bundle | 12 | 5 | 7 |
| **TOTAL** | **67** | **60** | **7** |

---

**Next Task**: P5-006 - Create GET /api/runs/{id}/evidence-notes endpoint
